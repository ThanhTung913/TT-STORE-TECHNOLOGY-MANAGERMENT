class AppPage {
    ...
    static BASE_URL_CLOUD_IMAGE = "https://res.cloudinary.com//image/upload";
    static BASE_URL_CLOUD_VIDEO = "https://res.cloudinary.com//video/upload";
...
class Product {
    constructor(id, title, slug, avatar, price, category) {
        this.id = id;
        this.title = title;
        this.slug = slug;
        this.avatar = avatar;
